...
export default function CanvasRipples() {
  React.useEffect(() => {
    ...
    function newframe() {
      ...
      for (var y = 0; y < height; y++) {
        for (var x = 0; x < width; x++) {
          ...
          data = (rippleMap[mapIdx - width] + rippleMap[mapIdx + width] + rippleMap[mapIdx - 1] + rippleMap[mapIdx + 1]) >> 1; // right shift 1 is same as divide by 2
  ...
  return <canvas className="canvas" width="400" height="400" />;
}
